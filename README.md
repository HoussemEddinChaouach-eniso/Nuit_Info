# 🐧 EcoLinux Migration - Plateforme Gamifiée de Transition Écologique
...
[Démo](#-démonstration) • [Installation](#-installation) • [Fonctionnalités](#-fonctionnalités) • [Contribuer](#-contribuer)
...
|----------------|-------------|
| 📊 **Tableau de bord** | Statistiques globales en temps réel (PC Windows vs Linux) |
| 🏫 **Liste des établissements** | Suivi individuel de chaque école, collège, lycée, université |
| 🎖️ **Système de badges** | 🌟 Débutant → 🥉 Bronze → 🥈 Argent → 🥇 Or → 💎 Platine → 👑 Champion |
| 📈 **9 Niveaux** | Progression basée sur le % de conversion |
...
<video src="https://github.com/user-attachments/assets/3766caf4-ab77-4ed6-8324-f1ae7068f04f" controls>
...
Ce projet s'inscrit dans la démarche **Numérique Inclusif Responsable et Durable** :

| Pilier | Bénéfice |
|--------|----------|
| ♻️ **Écologique** | Linux prolonge la durée de vie des PC de 5-10 ans |
| 💰 **Économique** | Aucune licence payante, économies substantielles |
| 🔒 **Sécurisé** | Code open source, auditable et transparent |
| 🎓 **Éducatif** | Sensibilisation au numérique responsable |
| 🌐 **Inclusif** | Accessible à tous les établissements |
